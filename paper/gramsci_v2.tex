...
\todo{4PCF comparison: DESI z-binned connected 4PCF (rmin=20, rmax=65,
4 bins, 276 configurations) vs the same 25 EZmocks --- measurements
running; add figure and chi2 when complete.  Note: rmax=65 chosen after
the rmax=80 trial showed the C(nn,3) cost is dominated by the heavy
neighbour-count tail of the clustered LRG sample (2.6h for NGC zbin1
alone) --- worth a sentence in the text about real-data vs uniform-mock
scaling.}
