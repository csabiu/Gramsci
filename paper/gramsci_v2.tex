...
${\lesssim}5\%$, far below the effects reported here.  \todo{re-verify
sentinel timings on a quiescent node before submission
(analysis/benchmarks/verify\_sentinels.py)}
