...
A complementary null test on cosmological density fields --- the
parity-odd 4PCF measured across the parity-symmetric Quijote fiducial
realisations, which must be consistent with zero configuration by
configuration --- is reported in Section~\ref{sec:quijote}.
\todo{add Quijote null-test numbers (chi2/dof over configs) when the
campaign 4PCFp measurements complete}
