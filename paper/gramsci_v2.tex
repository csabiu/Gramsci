...
configuration by configuration.  Across 60 realisations
%% TODO refresh count when the campaign completes (final: ~66)
...
zero, with $4.9\%$ of configurations beyond $2\sigma$ (Gaussian
...
$\chi^2/{\rm dof} = (N_{\rm m}-1)/(N_{\rm m}-3) = 1.04$, from which the
